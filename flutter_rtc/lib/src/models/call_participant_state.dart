...
import 'package:flutter_rtc/src/models/sfu_connection_quality.dart';
import 'package:flutter_rtc/src/models/user_info.dart';
import 'package:flutter_rtc/src/models/viewport_visibility.dart';
...
//
//   get isScreenShareEnabled => false;
//
//   get isAudioEnabled => true;
//
//   get isVideoEnabled => true;
//
//   get videoTrack => null;
//
//   bool get isSpeaking => false;
//
//   bool get isDominantSpeaker => false;
//
//   get pin => false;
//
//   @override
...
class CallParticipantState
  ...
  final Map<dynamic, dynamic> publishedTracks;
  final bool isLocal;
  ...
  CallParticipantState copyWith({
    ...
    Map<dynamic, dynamic>? publishedTracks,
    bool? isLocal,
