...
import '../webrtc/media/constraints/facing_mode.dart';
import '../webrtc/media_constraints.dart';
import '../webrtc/rtc_media_device.dart';
...
abstract class TrackOption with EquatableMixin {
  ...
  factory TrackOption.provided(RtcLocalTrack track) {
    return TrackProvided._(track: track as RtcLocalTrack<MediaConstraints>);
  }
